...
When all rounds are complete, users explicitly end the game to see final results. The game can be reopened for corrections, similar to unlocking a round.

## Scope

### In Scope

- End game action (requires all rounds locked)
