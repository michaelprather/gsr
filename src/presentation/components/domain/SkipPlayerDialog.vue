...
<template>
  <UiDialog :open="open" :title="`Skip ${playerName}`" @close="emit('close')">
    <div class="skip-player-dialog__options">
      <button type="button" class="skip-player-dialog__option" @click="emit('skip-round')">
        ...
        <div class="skip-player-dialog__option-content">
          ...
          <span class="skip-player-dialog__option-desc"
            >Player will be active again next round</span
          >
        </div>
      </button>

      <button type="button" class="skip-player-dialog__option" @click="emit('skip-all')">
        ...
        <div class="skip-player-dialog__option-content">
          ...
          <span class="skip-player-dialog__option-desc"
            >Player will be skipped for all remaining rounds</span
          >
        </div>
      </button>
    </div>
