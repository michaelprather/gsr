    ...
    <section class="help-view__content">
      <article class="help-view__section">
        ...
        <p class="help-view__text">
          Be the first player to "go out" by laying down all your cards in valid
          books and runs. The player who goes out scores 0 points for the round,
          while other players are penalized for the cards left in their hand.
        </p>

        <h3 class="help-view__subsection-title">Books and Runs</h3>
        <p class="help-view__text">
          A <strong>book</strong> is a set of 3 or more cards of the same rank
          (e.g., three 7s or four Kings).
        </p>
        <p class="help-view__text">
          A <strong>run</strong> is a sequence of 3 or more consecutive cards
          in the same suit (e.g., 4-5-6 of hearts). Aces are always high.
        </p>
        <p class="help-view__text">
        ...
        <p class="help-view__text">
          George Street Rummy is played over 7 rounds. Each player is dealt 11
          cards in every round. Each round has specific requirements that must
          be met before a player can lay down cards:
        </p>
        ...
        <ul class="help-view__list">
          ...
          <li><strong>Play:</strong> Optionally lay down books or runs, or add to existing melds</li>
        ...
        <p class="help-view__text">
          Once you have laid down your required books and runs, you may play
          cards on melds that other players have laid down. You can add cards
          to extend their books or runs.
        </p>

        <h3 class="help-view__subsection-title">Joker Rules</h3>
        <p class="help-view__text">
          You may take a joker from any meld on the table (yours or another
          player's) by replacing it with the card it represents. Any joker
          taken this way must be played before your turn ends—it cannot be
          kept in your hand.
        </p>

        <h3 class="help-view__subsection-title">Going Out</h3>
        <p class="help-view__text">
          To go out, you must lay down all remaining cards in valid melds and
          discard your final card. You cannot go out if you have cards that
          cannot be melded.
        </p>

        <h3 class="help-view__subsection-title">Final Round</h3>
        <p class="help-view__text">
          In the final round, players cannot lay down any cards until they can
          play every card in their hand without discarding.
        </p>
      </article>
      ...
      <article class="help-view__section">
        ...
        <p class="help-view__text">
          The player with the <strong>lowest total score</strong> after all 7
      ...
      <article class="help-view__section">
        ...
        <p class="help-view__text">
          Enter player names on the setup screen and tap "Start Game" when you
          have at least 2 players.
        </p>

        <h3 class="help-view__subsection-title">Recording Scores</h3>
        <p class="help-view__text">
          After each round, enter each player's score. The round winner should
          have 0 points. Tap the crown icon to quickly set a player as the
          winner.
        </p>
        ...
        <p class="help-view__text">
          ...
          You can skip them for just the current round or all remaining rounds.
        </p>

        <h3 class="help-view__subsection-title">Viewing Standings</h3>
        <p class="help-view__text">
          Tap "Standings" to see current rankings. Rotate your device to
          landscape mode to view the full scorecard.
        </p>

        <h3 class="help-view__subsection-title">Sharing Games</h3>
        <p class="help-view__text">
          Tap the share icon to generate a QR code or link that lets others
          import the game on their device.
        </p>
      </article>
    </section>
  </main>
